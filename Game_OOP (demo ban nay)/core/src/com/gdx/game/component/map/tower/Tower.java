...
public class Tower extends Entity {
    ...
    public void checkIfTouched(SpriteBatch spriteBatch) {
        ...
        if(checkIfTouchedRight((int)x,(int)y,widthSprite,heightSprite)) {
            if (type == 1 && lvlOfTower == 1){ this.sellTower(PRICE_TOWER_1);}
            if (type == 1 && lvlOfTower == 2){ this.sellTower(PRICE_UPGRADE_TOWER_1_TURN_1);}
            if (type == 1 && lvlOfTower == 3){ this.sellTower(PRICE_UPGRADE_TOWER_1_TURN_2);}

            //---------------------------------------

            if (type == 2 && lvlOfTower == 1){ this.sellTower(PRICE_TOWER_2);}
            if (type == 2 && lvlOfTower == 2){ this.sellTower(PRICE_UPGRADE_TOWER_2_TURN_1);}
            if (type == 2 && lvlOfTower == 3){ this.sellTower(PRICE_UPGRADE_TOWER_2_TURN_2);}

            //---------------------------------------
            if (type == 3 && lvlOfTower == 1){ this.sellTower(PRICE_TOWER_3);}
            if (type == 3 && lvlOfTower == 2){ this.sellTower(PRICE_UPGRADE_TOWER_3_TURN_1);}
            if (type == 3 && lvlOfTower == 3){ this.sellTower(PRICE_UPGRADE_TOWER_3_TURN_2);}
