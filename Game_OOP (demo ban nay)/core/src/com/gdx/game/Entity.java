...
public abstract class Entity implements Disposable{
    ...
    protected static int money = 8000 ;
    ...
    public void sellTower(int price) {this.setMoney(this.getMoney() + price/2);}
    ...
    public boolean checkIfTouchedRight(int x, int y, int width, int height) {
        if (Gdx.input.getX() > x - width/2 && Gdx.input.getX() < x + width/2 && Gdx.input.getY() > 1000 - (y + height/2) && Gdx.input.getY() < 1000 - (y - height/2) )
